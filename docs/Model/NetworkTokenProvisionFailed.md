...
**name** | **string** | The name of this resource. Is always &#x60;network-token-provision-failed&#x60;. | [optional]
**created_at** | **\DateTime** | The date and time when this event was created in our system. | [optional]
**context** | [**\Gr4vy\model\NetworkTokenProvisionFailedContext**](NetworkTokenProvisionFailedContext.md) |  | [optional]
