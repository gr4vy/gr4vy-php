...
**name** | **string** | The name of this resource. Is always &#x60;payment-connector-response-transaction-authorization-failed&#x60;. | [optional]
**created_at** | **\DateTime** | The date and time when this transaction was created in our system. | [optional]
**context** | [**\Gr4vy\model\PaymentConnectorResponseTransactionAuthorizationFailedEventContext**](PaymentConnectorResponseTransactionAuthorizationFailedEventContext.md) |  | [optional]
