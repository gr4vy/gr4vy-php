...
<!-- UsageSnippet language="php" operationID="get_transaction_refund_settlement" method="get" path="/transactions/{transaction_id}/refund-settlements/{settlement_id}" -->
```php
...
**[?GetTransactionRefundSettlementResponse](../../GetTransactionRefundSettlementResponse.md)**
...
<!-- UsageSnippet language="php" operationID="list_transaction_refund_settlements" method="get" path="/transactions/{transaction_id}/refund-settlements" -->
```php
declare(strict_types=1);
...
**[?ListTransactionRefundSettlementsResponse](../../ListTransactionRefundSettlementsResponse.md)**
