...
class PaymentMethodsApi
{
     ...
     * New payment method
     *
     * @param  \Gr4vy\model\CardRequest $card_request card_request (optional)
     *
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gr4vy\model\Card|\Gr4vy\model\ErrorGeneric|\Gr4vy\model\Error401Unauthorized
     */
    public function storePaymentMethod($card_request = null)
    {
        list($response) = $this->storePaymentMethodWithHttpInfo($card_request);
        return $response;
    }
     ...
     * New payment method
     *
     * @param  \Gr4vy\model\CardRequest $card_request (optional)
     *
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gr4vy\model\Card|\Gr4vy\model\ErrorGeneric|\Gr4vy\model\Error401Unauthorized, HTTP status code, HTTP response headers (array of strings)
     */
    public function storePaymentMethodWithHttpInfo($card_request = null)
    {
        $request = $this->storePaymentMethodRequest($card_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gr4vy\model\Card' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gr4vy\model\Card', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storePaymentMethodAsync($card_request = null)
    {
        return $this->storePaymentMethodAsyncWithHttpInfo($card_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storePaymentMethodAsyncWithHttpInfo($card_request = null)
    {
        $returnType = '\Gr4vy\model\Card';
        $request = $this->storePaymentMethodRequest($card_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storePaymentMethodRequest($card_request = null)
    {
