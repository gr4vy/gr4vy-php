...
class PaymentMethodsApi
{
     ...
     * New payment method
     *
     * @param  \Gr4vy\model\UNKNOWN_BASE_TYPE $unknown_base_type unknown_base_type (optional)
     *
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gr4vy\model\PaymentMethod|OneOfError400BadRequestError400IncorrectJson|\Gr4vy\model\Error401Unauthorized
     */
    public function storePaymentMethod($unknown_base_type = null)
    {
        list($response) = $this->storePaymentMethodWithHttpInfo($unknown_base_type);
        return $response;
    }
     ...
     * New payment method
     *
     * @param  \Gr4vy\model\UNKNOWN_BASE_TYPE $unknown_base_type (optional)
     *
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gr4vy\model\PaymentMethod|OneOfError400BadRequestError400IncorrectJson|\Gr4vy\model\Error401Unauthorized, HTTP status code, HTTP response headers (array of strings)
     */
    public function storePaymentMethodWithHttpInfo($unknown_base_type = null)
    {
        $request = $this->storePaymentMethodRequest($unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storePaymentMethodAsync($unknown_base_type = null)
    {
        return $this->storePaymentMethodAsyncWithHttpInfo($unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storePaymentMethodAsyncWithHttpInfo($unknown_base_type = null)
    {
        $returnType = '\Gr4vy\model\PaymentMethod';
        $request = $this->storePaymentMethodRequest($unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storePaymentMethodRequest($unknown_base_type = null)
    {
