...
class PaymentOptionsApi
{
     ...
     */
    public function listPaymentOptions($country = null, $currency = null, $environment = 'production')
    {
        list($response) = $this->listPaymentOptionsWithHttpInfo($country, $currency, $environment);
        return $response;
    }
     ...
     */
    public function listPaymentOptionsWithHttpInfo($country = null, $currency = null, $environment = 'production')
    {
        $request = $this->listPaymentOptionsRequest($country, $currency, $environment);
     ...
     */
    public function listPaymentOptionsAsync($country = null, $currency = null, $environment = 'production')
    {
        return $this->listPaymentOptionsAsyncWithHttpInfo($country, $currency, $environment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPaymentOptionsAsyncWithHttpInfo($country = null, $currency = null, $environment = 'production')
    {
        $returnType = '\Gr4vy\model\PaymentOptions';
        $request = $this->listPaymentOptionsRequest($country, $currency, $environment);
     ...
     */
    public function listPaymentOptionsRequest($country = null, $currency = null, $environment = 'production')
    {
