...
class TransactionsApi
{
     ...
     * @return \Gr4vy\model\Transaction|OneOfError400BadRequestError400IncorrectJson|\Gr4vy\model\Error401Unauthorized
     */
     ...
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gr4vy\model\Transaction|OneOfError400BadRequestError400IncorrectJson|\Gr4vy\model\Error401Unauthorized, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gr4vy\model\Transaction|OneOfError400BadRequestError400IncorrectJson|\Gr4vy\model\Error401Unauthorized|OneOfError404NotFoundError404PendingCreation
     */
     ...
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gr4vy\model\Transaction|OneOfError400BadRequestError400IncorrectJson|\Gr4vy\model\Error401Unauthorized|OneOfError404NotFoundError404PendingCreation, HTTP status code, HTTP response headers (array of strings)
     */
    public function captureTransactionWithHttpInfo($transaction_id, $transaction_capture_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 404:
                    if ('OneOfError404NotFoundError404PendingCreation' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'OneOfError404NotFoundError404PendingCreation', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'OneOfError404NotFoundError404PendingCreation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gr4vy\model\Transaction|\Gr4vy\model\Error401Unauthorized|OneOfError404NotFoundError404PendingCreation
     */
     ...
     * @throws \Gr4vy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gr4vy\model\Transaction|\Gr4vy\model\Error401Unauthorized|OneOfError404NotFoundError404PendingCreation, HTTP status code, HTTP response headers (array of strings)
     */
