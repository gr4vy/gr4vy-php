...
class Action implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const ID_DECLINE_EARLY = 'decline-early';
    const ID_ROUTE_TRANSACTION = 'route-transaction';
    const ID_SKIP_3DS = 'skip-3ds';
    const FLOW_CHECKOUT = 'checkout';
    const FLOW_CARD_TRANSACTION = 'card-transaction';
