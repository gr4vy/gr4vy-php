...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStateCode($state_code)
    {
        if (!is_null($state_code) && (mb_strlen($state_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling Address., must be smaller than or equal to 6.');
        }
        if (!is_null($state_code) && (mb_strlen($state_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling Address., must be bigger than or equal to 4.');
        }
    ...
    public function setHouseNumberOrName($house_number_or_name)
    {
        if (!is_null($house_number_or_name) && (mb_strlen($house_number_or_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $house_number_or_name when calling Address., must be smaller than or equal to 255.');
        }
        if (!is_null($house_number_or_name) && (mb_strlen($house_number_or_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number_or_name when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setLine2($line2)
    {
        if (!is_null($line2) && (mb_strlen($line2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling Address., must be smaller than or equal to 255.');
        }
        if (!is_null($line2) && (mb_strlen($line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setOrganization($organization)
    {
        if (!is_null($organization) && (mb_strlen($organization) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling Address., must be smaller than or equal to 255.');
        }
        if (!is_null($organization) && (mb_strlen($organization) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling Address., must be bigger than or equal to 1.');
        }
