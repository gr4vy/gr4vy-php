...
/**
 * AntiFraudDecisionEventContext Class Doc Comment
 *
 * @category Class
 ...
 */
class AntiFraudDecisionEventContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AntiFraudDecisionEvent_context';
     ...
     *
     * @param string|null $anti_fraud_service_check_id The external ID of the decision.
     *
     * @return self
     */
     ...
     * Sets decision
     *
     * @param string|null $decision The parsed decision response from the anti-fraud provider response.
     *
     * @return self
     */
