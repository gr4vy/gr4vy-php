...
/**
 * AntiFraudServiceCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class AntiFraudServiceCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AntiFraudServiceCreate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['display_name']) > 200)) {
     ...
     * Sets display_name
     *
     * @param string $display_name A unique name for this anti-fraud service which is used in the Gr4vy admin panel to give a anti-fraud Service a human readable name.
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        if ((mb_strlen($display_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling AntiFraudServiceCreate., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling AntiFraudServiceCreate., must be bigger than or equal to 1.');
        }
     ...
     * Gets fields
     *
     * @return \Gr4vy\model\AntiFraudServiceUpdateFieldsInner[]
     */
