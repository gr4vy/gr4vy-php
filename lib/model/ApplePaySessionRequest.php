...
class ApplePaySessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets validation_url
     *
     * @param string $validation_url Validation URL obtained from the event passed to a `onvalidatemerchant` callback.
     *
     * @return self
     */
     ...
     * Sets domain_name
     *
     * @param string $domain_name Fully qualified domain name of the merchant.
     *
     * @return self
     */
