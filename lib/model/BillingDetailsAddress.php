...
class BillingDetailsAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling BillingDetailsAddress., must be smaller than or equal to 100.');
        }
        if (!is_null($city) && (mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillingDetailsAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $state when calling BillingDetailsAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setStateCode($state_code)
    {
        if (!is_null($state_code) && (mb_strlen($state_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling BillingDetailsAddress., must be smaller than or equal to 6.');
        }
        if (!is_null($state_code) && (mb_strlen($state_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling BillingDetailsAddress., must be bigger than or equal to 4.');
        }
    ...
    public function setHouseNumberOrName($house_number_or_name)
    {
        if (!is_null($house_number_or_name) && (mb_strlen($house_number_or_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $house_number_or_name when calling BillingDetailsAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($house_number_or_name) && (mb_strlen($house_number_or_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_number_or_name when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLine1($line1)
    {
        if (!is_null($line1) && (mb_strlen($line1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling BillingDetailsAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($line1) && (mb_strlen($line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLine2($line2)
    {
        if (!is_null($line2) && (mb_strlen($line2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling BillingDetailsAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($line2) && (mb_strlen($line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setOrganization($organization)
    {
        if (!is_null($organization) && (mb_strlen($organization) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling BillingDetailsAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($organization) && (mb_strlen($organization) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling BillingDetailsAddress., must be bigger than or equal to 1.');
        }
