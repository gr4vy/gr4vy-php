...
/**
 * BillingDetailsTaxId Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingDetailsTaxId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingDetails_tax_id';
    ...
    public function setValue($value)
    {
        if ((mb_strlen($value) > 50)) {
            throw new \InvalidArgumentException('invalid length for $value when calling BillingDetailsTaxId., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling BillingDetailsTaxId., must be bigger than or equal to 1.');
        }
