...
/**
 * BuyerRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BuyerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BuyerRequest';
    ...
    protected static $openAPITypes = [
        ...
        'display_name' => 'string',
        'billing_details' => '\Gr4vy\model\BuyerRequestBillingDetails'
    ];
    ...
    public function setExternalIdentifier($external_identifier)
    {
        if (!is_null($external_identifier) && (mb_strlen($external_identifier) > 200)) {
            throw new \InvalidArgumentException('invalid length for $external_identifier when calling BuyerRequest., must be smaller than or equal to 200.');
        }
        if (!is_null($external_identifier) && (mb_strlen($external_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_identifier when calling BuyerRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling BuyerRequest., must be smaller than or equal to 200.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling BuyerRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Gr4vy\model\BuyerRequestBillingDetails|null
     */
