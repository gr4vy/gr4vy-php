...
class CardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardRequest';
    ...
    public function setExpirationDate($expiration_date)
    {
        if ((mb_strlen($expiration_date) > 5)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling CardRequest., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($expiration_date) < 5)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling CardRequest., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/^\\d{2}\/\\d{2}$/", $expiration_date))) {
            throw new \InvalidArgumentException("invalid value for $expiration_date when calling CardRequest., must conform to the pattern /^\\d{2}\/\\d{2}$/.");
        }
