...
/**
 * CardRuleRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CardRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardRuleRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['conditions']) < 1)) {
            $invalidProperties[] = "invalid value for 'conditions', number of items must be greater than or equal to 1.";
        }

        if ($this->container['payment_service_ids'] === null) {
            $invalidProperties[] = "'payment_service_ids' can't be null";
        }
     ...
     * Sets position
     *
     * @param float|null $position The numeric rank of a rule. Rules with a lower position value are processed first. When a rule is inserted at a position, any rules with the the same value or higher are down a position accordingly. When left out, the rule is inserted at the end of the list.
     *
     * @return self
     */
     ...
     * Gets conditions
     *
     * @return \Gr4vy\model\CardRuleCondition[]
     */
     ...
     * Sets conditions
     *
     * @param \Gr4vy\model\CardRuleCondition[] $conditions One or more conditions that apply for this rule. Each condition needs to match for this rule to go into effect.
     *
     * @return self
     */
    public function setConditions($conditions)
    {
        ...
        if ((count($conditions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $conditions when calling CardRuleRequest., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param string[] $payment_service_ids A list of IDs for the payment services to use, in order of priority. The payment services all need to process cards.
     *
     * @return self
     */
