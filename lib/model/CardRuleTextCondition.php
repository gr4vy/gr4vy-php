...
class CardRuleTextCondition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['values']) > 100)) {
     ...
     * Sets values
     *
     * @param string[] $values The values to compare the `key` to.
     *
     * @return self
     */
    public function setValues($values)
    {
        ...
        if ((count($values) > 100)) {
            throw new \InvalidArgumentException('invalid value for $values when calling CardRuleTextCondition., number of items must be less than or equal to 100.');
        }
        if ((count($values) < 1)) {
            throw new \InvalidArgumentException('invalid length for $values when calling CardRuleTextCondition., number of items must be greater than or equal to 1.');
        }
