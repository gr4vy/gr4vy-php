...
class CartItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets tax_amount
     *
     * @param int|null $tax_amount The tax amount for this item represented as a monetary amount in the smallest currency unit for the given currency, for example `1299` USD cents represents `$12.99`.  Important: this amount is for the total of the cart item and not for an individual item. For example, if the quantity is 5, this value should be the total tax amount for 5 of the cart item.
     *
     * @return self
     */
