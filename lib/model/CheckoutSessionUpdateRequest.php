...
class CheckoutSessionUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMetadata($metadata)
    {
        ...
        if (!is_null($metadata) && (count($metadata) > 20)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling CheckoutSessionUpdateRequest., number of items must be less than or equal to 20.');
        }
