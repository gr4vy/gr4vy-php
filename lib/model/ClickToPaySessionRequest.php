...
/**
 * ClickToPaySessionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ClickToPaySessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClickToPaySessionRequest';
     ...
     *
     * @param string $checkout_session_id The identifier for the current checkout session.
     *
     * @return self
     */
