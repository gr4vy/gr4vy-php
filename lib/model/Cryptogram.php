 ...
 */
class Cryptogram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cryptogram';
     ...
     * Sets cryptogram
     *
     * @param string|null $cryptogram The cryptogram of the network token.
     *
     * @return self
     */
