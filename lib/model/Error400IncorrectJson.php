...
/**
 * Error400IncorrectJson Class Doc Comment
 *
 * @category Class
 ...
 */
class Error400IncorrectJson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Error400IncorrectJson';
    ...
    public const CODE_INCORRECT_JSON = 'incorrect_json';
     ...
     * Sets code
     *
     * @param string|null $code `incorrect_json`.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Incorrect JSON. The request body could not be parsed as valid JSON.
     *
     * @return self
     */
