...
class Error401Unauthorized implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MESSAGE_NO_VALID_API_AUTHENTICATION_FOUND = 'No valid API authentication found';
    ...
    {
        return [
            self::MESSAGE_NO_VALID_API_AUTHENTICATION_FOUND,
        ];
    }
     ...
     * Sets code
     *
     * @param string|null $code `unauthorized`.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message No valid API authentication found.
     *
     * @return self
     */
