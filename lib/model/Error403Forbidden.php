...
/**
 * Error403Forbidden Class Doc Comment
 *
 * @category Class
 ...
 */
class Error403Forbidden implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Error403Forbidden';
     ...
     * Sets code
     *
     * @param string|null $code `forbidden`.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Invalid credentials.
     *
     * @return self
     */
