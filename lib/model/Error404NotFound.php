...
/**
 * Error404NotFound Class Doc Comment
 *
 * @category Class
 ...
 */
class Error404NotFound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Error404NotFound';
    ...
    public const MESSAGE_THE_RESOURCE_COULD_NOT_BE_FOUND = 'The resource could not be found';
    ...
    {
        return [
            self::MESSAGE_THE_RESOURCE_COULD_NOT_BE_FOUND,
        ];
    }
     ...
     * Sets message
     *
     * @param string|null $message The resource could not be found.
     *
     * @return self
     */
