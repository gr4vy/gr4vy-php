...
/**
 * Error404PendingCreation Class Doc Comment
 *
 * @category Class
 ...
 */
class Error404PendingCreation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Error404PendingCreation';
    ...
    public const CODE_PENDING_CREATION = 'pending_creation';
    public const STATUS_404 = 404;
    public const MESSAGE_THE_RESOURCE_IS_STILL_PENDING = 'The resource is still pending';
    ...
    {
        return [
            self::MESSAGE_THE_RESOURCE_IS_STILL_PENDING,
        ];
    }
     ...
     * Sets code
     *
     * @param string|null $code `pending_creation`.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message The resource is still pending.
     *
     * @return self
     */
