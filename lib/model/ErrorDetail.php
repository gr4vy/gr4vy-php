...
class ErrorDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets location
     *
     * @param string|null $location The location where the error caused an issue.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type A unique identifier for the type of error that occurred.
     *
     * @return self
     */
     ...
     * Sets pointer
     *
     * @param string|null $pointer The exact item for which the validation did not succeed. This is a JSON pointer for request bodies, while for query, path, and header parameters it is the name of the parameter.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A human readable message for this error detail.
     *
     * @return self
     */
