...
/**
 * GiftCardBalanceNewRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GiftCardBalanceNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GiftCardBalanceNewRequest';
    ...
    public function setNumber($number)
    {
        if ((mb_strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling GiftCardBalanceNewRequest., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($number) < 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling GiftCardBalanceNewRequest., must be bigger than or equal to 16.');
        }
        if ((!preg_match("/^[0-9]{16,19}$/", $number))) {
            throw new \InvalidArgumentException("invalid value for $number when calling GiftCardBalanceNewRequest., must conform to the pattern /^[0-9]{16,19}$/.");
        }
