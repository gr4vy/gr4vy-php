...
/**
 * GiftCardRedemptionSucceededContext Class Doc Comment
 *
 * @category Class
 ...
 */
class GiftCardRedemptionSucceededContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GiftCardRedemptionSucceeded_context';
     ...
     * Sets request
     *
     * @param string|null $request The HTTP body sent to the Gift Card provider.
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param string|null $response The HTTP body received from the Gift Card provider.
     *
     * @return self
     */
     ...
     *
     * @param float|null $response_status_code The HTTP response status code from the Gift Card provider.
     *
     * @return self
     */
