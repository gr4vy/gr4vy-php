...
/**
 * GiftCardSnapshot Class Doc Comment
 *
 * @category Class
 ...
 */
class GiftCardSnapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GiftCard--Snapshot';
     ...
     * Sets id
     *
     * @param string|null $id The ID of this gift card. This may be `null` if the gift card is not stored.
     *
     * @return self
     */
