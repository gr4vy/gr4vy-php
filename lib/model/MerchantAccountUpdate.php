...
/**
 * MerchantAccountUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class MerchantAccountUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantAccountUpdate';
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling MerchantAccountUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling MerchantAccountUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setVisaNetworkTokensRequestorId($visa_network_tokens_requestor_id)
    {
        if (!is_null($visa_network_tokens_requestor_id) && (mb_strlen($visa_network_tokens_requestor_id) > 300)) {
            throw new \InvalidArgumentException('invalid length for $visa_network_tokens_requestor_id when calling MerchantAccountUpdate., must be smaller than or equal to 300.');
        }
    ...
    public function setVisaNetworkTokensAppId($visa_network_tokens_app_id)
    {
        if (!is_null($visa_network_tokens_app_id) && (mb_strlen($visa_network_tokens_app_id) > 300)) {
            throw new \InvalidArgumentException('invalid length for $visa_network_tokens_app_id when calling MerchantAccountUpdate., must be smaller than or equal to 300.');
        }
    ...
    public function setAmexNetworkTokensRequestorId($amex_network_tokens_requestor_id)
    {
        if (!is_null($amex_network_tokens_requestor_id) && (mb_strlen($amex_network_tokens_requestor_id) > 300)) {
            throw new \InvalidArgumentException('invalid length for $amex_network_tokens_requestor_id when calling MerchantAccountUpdate., must be smaller than or equal to 300.');
        }
    ...
    public function setAmexNetworkTokensAppId($amex_network_tokens_app_id)
    {
        if (!is_null($amex_network_tokens_app_id) && (mb_strlen($amex_network_tokens_app_id) > 300)) {
            throw new \InvalidArgumentException('invalid length for $amex_network_tokens_app_id when calling MerchantAccountUpdate., must be smaller than or equal to 300.');
        }
    ...
    public function setMastercardNetworkTokensRequestorId($mastercard_network_tokens_requestor_id)
    {
        if (!is_null($mastercard_network_tokens_requestor_id) && (mb_strlen($mastercard_network_tokens_requestor_id) > 300)) {
            throw new \InvalidArgumentException('invalid length for $mastercard_network_tokens_requestor_id when calling MerchantAccountUpdate., must be smaller than or equal to 300.');
        }
    ...
    public function setMastercardNetworkTokensAppId($mastercard_network_tokens_app_id)
    {
        if (!is_null($mastercard_network_tokens_app_id) && (mb_strlen($mastercard_network_tokens_app_id) > 300)) {
            throw new \InvalidArgumentException('invalid length for $mastercard_network_tokens_app_id when calling MerchantAccountUpdate., must be smaller than or equal to 300.');
        }
    ...
    public function setLoonClientKey($loon_client_key)
    {
        ...
        if (!is_null($loon_client_key) && (mb_strlen($loon_client_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $loon_client_key when calling MerchantAccountUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setLoonSecretKey($loon_secret_key)
    {
        ...
        if (!is_null($loon_secret_key) && (mb_strlen($loon_secret_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $loon_secret_key when calling MerchantAccountUpdate., must be bigger than or equal to 1.');
        }
