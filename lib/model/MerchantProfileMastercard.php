...
/**
 * MerchantProfileMastercard Class Doc Comment
 *
 * @category Class
 ...
 */
class MerchantProfileMastercard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantProfile_mastercard';
    ...
    public function setMerchantAcquirerBin($merchant_acquirer_bin)
    {
        if (!is_null($merchant_acquirer_bin) && (mb_strlen($merchant_acquirer_bin) > 11)) {
            throw new \InvalidArgumentException('invalid length for $merchant_acquirer_bin when calling MerchantProfileMastercard., must be smaller than or equal to 11.');
        }
    ...
    public function setMerchantAcquirerId($merchant_acquirer_id)
    {
        if (!is_null($merchant_acquirer_id) && (mb_strlen($merchant_acquirer_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $merchant_acquirer_id when calling MerchantProfileMastercard., must be smaller than or equal to 35.');
        }
    ...
    public function setMerchantName($merchant_name)
    {
        if (!is_null($merchant_name) && (mb_strlen($merchant_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $merchant_name when calling MerchantProfileMastercard., must be smaller than or equal to 40.');
        }
    ...
    public function setMerchantCountryCode($merchant_country_code)
    {
        if (!is_null($merchant_country_code) && (mb_strlen($merchant_country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $merchant_country_code when calling MerchantProfileMastercard., must be smaller than or equal to 3.');
        }
        if (!is_null($merchant_country_code) && (mb_strlen($merchant_country_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $merchant_country_code when calling MerchantProfileMastercard., must be bigger than or equal to 3.');
        }
    ...
    public function setMerchantCategoryCode($merchant_category_code)
    {
        if (!is_null($merchant_category_code) && (mb_strlen($merchant_category_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_category_code when calling MerchantProfileMastercard., must be smaller than or equal to 4.');
        }
