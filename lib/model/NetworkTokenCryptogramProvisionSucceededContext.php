...
/**
 * NetworkTokenCryptogramProvisionSucceededContext Class Doc Comment
 *
 * @category Class
 ...
 */
class NetworkTokenCryptogramProvisionSucceededContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkTokenCryptogramProvisionSucceeded_context';
     ...
     * Sets request
     *
     * @param string|null $request The HTTP body sent to the Network Token provider.
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param string|null $response The HTTP body received from the Network Token provider.
     *
     * @return self
     */
     ...
     *
     * @param float|null $response_status_code The HTTP response status code from the Network Token provider.
     *
     * @return self
     */
