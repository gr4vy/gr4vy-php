...
/**
 * PaymentConnectorResponseTransactionAuthorizationFailedEventContext Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentConnectorResponseTransactionAuthorizationFailedEventContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConnectorResponseTransactionAuthorizationFailedEvent_context';
     ...
     * Sets status
     *
     * @param string|null $status The new status code for the transaction. This is always set to `authorization_failed`.
     *
     * @return self
     */
