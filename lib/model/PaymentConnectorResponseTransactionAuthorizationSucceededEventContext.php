...
/**
 * PaymentConnectorResponseTransactionAuthorizationSucceededEventContext Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentConnectorResponseTransactionAuthorizationSucceededEventContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConnectorResponseTransactionAuthorizationSucceededEvent_context';
     ...
     * Sets status
     *
     * @param string|null $status The new status code for the transaction. This is always set to `authorization_succeeded`.
     *
     * @return self
     */
     ...
     * Sets retry_rule
     *
     * @param string|null $retry_rule This will always be `null` because the transaction succeeded.
     *
     * @return self
     * @deprecated
     */
