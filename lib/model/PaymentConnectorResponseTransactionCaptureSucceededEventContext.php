...
/**
 * PaymentConnectorResponseTransactionCaptureSucceededEventContext Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentConnectorResponseTransactionCaptureSucceededEventContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConnectorResponseTransactionCaptureSucceededEvent_context';
     ...
     * Sets status
     *
     * @param string|null $status The new status code for the transaction. This is always set to `capture_succeeded`.
     *
     * @return self
     */
