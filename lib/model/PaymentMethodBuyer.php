...
/**
 * PaymentMethodBuyer Class Doc Comment
 *
 * @category Class
 * @package  Gr4vy
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodBuyer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethod_buyer';
    ...
    public function setExternalIdentifier($external_identifier)
    {
        if (!is_null($external_identifier) && (mb_strlen($external_identifier) > 200)) {
            throw new \InvalidArgumentException('invalid length for $external_identifier when calling PaymentMethodBuyer., must be smaller than or equal to 200.');
        }
        if (!is_null($external_identifier) && (mb_strlen($external_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_identifier when calling PaymentMethodBuyer., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling PaymentMethodBuyer., must be smaller than or equal to 200.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling PaymentMethodBuyer., must be bigger than or equal to 1.');
        }
