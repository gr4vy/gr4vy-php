...
/**
 * PaymentMethodDetailsCard Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDetailsCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodDetailsCard';
     ...
     * Sets card_type
     *
     * @param string|null $card_type The type of card, one of `credit`, `debit` or `prepaid`.
     *
     * @return self
     */
     ...
     * Sets bin
     *
     * @param string|null $bin The first 6 digits of the full card number (the BIN).
     *
     * @return self
     */
