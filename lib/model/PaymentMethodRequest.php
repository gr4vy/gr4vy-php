...
/**
 * PaymentMethodRequest Class Doc Comment
 *
 * @category Class
 * @description Payment method details used to register a new payment method.
 * @package  Gr4vy
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PaymentMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodRequest';
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PaymentMethodRequest., must be smaller than or equal to 16.');
        }
        if (!is_null($number) && (mb_strlen($number) < 14)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PaymentMethodRequest., must be bigger than or equal to 14.');
        }
        if (!is_null($number) && (!preg_match("/^[0-9]{14,16}$/", $number))) {
            throw new \InvalidArgumentException("invalid value for $number when calling PaymentMethodRequest., must conform to the pattern /^[0-9]{14,16}$/.");
        }
    ...
    public function setExpirationDate($expiration_date)
    {
        if (!is_null($expiration_date) && (mb_strlen($expiration_date) > 5)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling PaymentMethodRequest., must be smaller than or equal to 5.');
        }
        if (!is_null($expiration_date) && (mb_strlen($expiration_date) < 5)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling PaymentMethodRequest., must be bigger than or equal to 5.');
        }
        if (!is_null($expiration_date) && (!preg_match("/^\\d\\d\/\\d\\d$/", $expiration_date))) {
            throw new \InvalidArgumentException("invalid value for $expiration_date when calling PaymentMethodRequest., must conform to the pattern /^\\d\\d\/\\d\\d$/.");
        }
     ...
     * Sets currency
     *
     * @param string|null $currency The ISO-4217 currency code to store this payment method for. This is used to select the payment service to use.  This only applies to `redirect` mode payment methods like `gocardless`.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The 2-letter ISO code of the country to store this payment method for. This is used to select the payment service to use.  This only applies to `redirect` mode payment methods like `gocardless`.
     *
     * @return self
     */
