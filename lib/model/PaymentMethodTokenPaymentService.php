<?php
/**
 * PaymentMethodTokenPaymentService
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PaymentMethodTokenPaymentService Class Doc Comment
 *
 * @category Class
 * @package  Gr4vy
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodTokenPaymentService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodToken_payment_service';
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 200)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentMethodTokenPaymentService., must be smaller than or equal to 200.');
        }
        if (!is_null($id) && (mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentMethodTokenPaymentService., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentServiceDefinitionId($payment_service_definition_id)
    {
        if (!is_null($payment_service_definition_id) && (mb_strlen($payment_service_definition_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $payment_service_definition_id when calling PaymentMethodTokenPaymentService., must be smaller than or equal to 50.');
        }
        if (!is_null($payment_service_definition_id) && (mb_strlen($payment_service_definition_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_service_definition_id when calling PaymentMethodTokenPaymentService., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling PaymentMethodTokenPaymentService., must be smaller than or equal to 50.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling PaymentMethodTokenPaymentService., must be bigger than or equal to 1.');
        }
