...
/**
 * PaymentServiceFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  Gr4vy
 * @author   OpenAPI Generator team
 ...
 */
class PaymentServiceFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentService_fields_inner';
    ...
    public function setKey($key)
    {
        ...
        if (!is_null($key) && (mb_strlen($key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $key when calling PaymentServiceFieldsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PaymentServiceFieldsInner., must be smaller than or equal to 5000.');
        }
        if (!is_null($value) && (mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PaymentServiceFieldsInner., must be bigger than or equal to 0.');
        }
