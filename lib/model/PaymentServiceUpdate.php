...
class PaymentServiceUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['credentials_mode'] = $data['credentials_mode'] ?? CREDENTIALS_MODE_LIVE;
    ...
    public function setEnvironments($environments)
    {
        ...
        if (!is_null($environments) && (count($environments) > 3)) {
            throw new \InvalidArgumentException('invalid value for $environments when calling PaymentServiceUpdate., number of items must be less than or equal to 3.');
        }
        if (!is_null($environments) && (count($environments) < 0)) {
            throw new \InvalidArgumentException('invalid length for $environments when calling PaymentServiceUpdate., number of items must be greater than or equal to 0.');
        }
