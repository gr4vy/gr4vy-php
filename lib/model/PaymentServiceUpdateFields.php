 ...
 */
class PaymentServiceUpdateFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentServiceUpdate_fields';
    ...
    {
        if ((mb_strlen($key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $key when calling PaymentServiceUpdateFields., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $key when calling PaymentServiceUpdateFields., must be bigger than or equal to 1.');
        }
