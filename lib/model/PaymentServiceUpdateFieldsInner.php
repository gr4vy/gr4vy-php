...
/**
 * PaymentServiceUpdateFieldsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentServiceUpdateFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentServiceUpdate_fields_inner';
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $key when calling PaymentServiceUpdateFieldsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        if ((mb_strlen($value) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PaymentServiceUpdateFieldsInner., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PaymentServiceUpdateFieldsInner., must be bigger than or equal to 1.');
        }
