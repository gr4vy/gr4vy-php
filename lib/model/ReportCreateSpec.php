...
/**
 * ReportCreateSpec Class Doc Comment
 *
 * @category Class
 ...
 */
class ReportCreateSpec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportCreate_spec';
    ...
    protected static $openAPITypes = [
        'model' => 'string',
        'params' => '\Gr4vy\model\ReportSpecParams'
    ];
    ...
    public const MODEL_TRANSACTIONS = 'transactions';
     ...
     * Sets model
     *
     * @param string $model The model (dataset) that the data used for the report is retrieved from.
     *
     * @return self
     */
     ...
     * Gets params
     *
     * @return \Gr4vy\model\ReportSpecParams
     */
     ...
     * Sets params
     *
     * @param \Gr4vy\model\ReportSpecParams $params params
     *
     * @return self
     */
