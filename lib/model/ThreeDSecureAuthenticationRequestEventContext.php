...
/**
 * ThreeDSecureAuthenticationRequestEventContext Class Doc Comment
 *
 * @category Class
 ...
 */
class ThreeDSecureAuthenticationRequestEventContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSecureAuthenticationRequestEvent_context';
     ...
     *
     * @param string|null $directory_response The `transStatus` parsed from the `response`.
     *
     * @return self
     */
