...
class ThreeDSecureData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if ((mb_strlen($eci) > 2)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling ThreeDSecureData., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($eci) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling ThreeDSecureData., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^0?\\d$/", $eci))) {
            throw new \InvalidArgumentException("invalid value for $eci when calling ThreeDSecureData., must conform to the pattern /^0?\\d$/.");
        }
    ...
    public function setVersion($version)
    {
        ...
        if ((!preg_match("/^[1-2].?[\\d+.?]{0,3}$/", $version))) {
            throw new \InvalidArgumentException("invalid value for $version when calling ThreeDSecureData., must conform to the pattern /^[1-2].?[\\d+.?]{0,3}$/.");
        }
    ...
    public function setDirectoryResponse($directory_response)
    {
        if ((mb_strlen($directory_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $directory_response when calling ThreeDSecureData., must be smaller than or equal to 1.');
        }
