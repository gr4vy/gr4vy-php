...
/**
 * ThreeDSecureDataV1 Class Doc Comment
 *
 * @category Class
 * @package  Gr4vy
 * @author   OpenAPI Generator team
 ...
 */
class ThreeDSecureDataV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSecureDataV1';
    ...
    public function setAuthenticationResponse($authentication_response)
    {
        if ((mb_strlen($authentication_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $authentication_response when calling ThreeDSecureDataV1., must be smaller than or equal to 1.');
        }
    ...
    public function setCavvAlgorithm($cavv_algorithm)
    {
        if ((mb_strlen($cavv_algorithm) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cavv_algorithm when calling ThreeDSecureDataV1., must be smaller than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($eci) > 2)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling ThreeDSecureDataV1., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($eci) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling ThreeDSecureDataV1., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^0?\\d$/", $eci))) {
            throw new \InvalidArgumentException("invalid value for $eci when calling ThreeDSecureDataV1., must conform to the pattern /^0?\\d$/.");
        }
    ...
    public function setVersion($version)
    {
        ...
        if ((!preg_match("/^[1-2].?[\\d+.?]{0,3}$/", $version))) {
            throw new \InvalidArgumentException("invalid value for $version when calling ThreeDSecureDataV1., must conform to the pattern /^[1-2].?[\\d+.?]{0,3}$/.");
        }
    ...
    public function setDirectoryResponse($directory_response)
    {
        if ((mb_strlen($directory_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $directory_response when calling ThreeDSecureDataV1., must be smaller than or equal to 1.');
        }
