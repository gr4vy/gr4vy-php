...
/**
 * ThreeDSecureError Class Doc Comment
 *
 * @category Class
 ...
 */
class ThreeDSecureError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSecureError';
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ThreeDSecureError., must be smaller than or equal to 2048.');
        }
    ...
    public function setDetail($detail)
    {
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ThreeDSecureError., must be smaller than or equal to 2048.');
        }
    ...
    {
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ThreeDSecureError., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ThreeDSecureError., must be bigger than or equal to 3.');
        }
    ...
    public function setComponent($component)
    {
        if ((mb_strlen($component) > 1)) {
            throw new \InvalidArgumentException('invalid length for $component when calling ThreeDSecureError., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($component) < 1)) {
            throw new \InvalidArgumentException('invalid length for $component when calling ThreeDSecureError., must be bigger than or equal to 1.');
        }
