 ...
 */
class ThreeDSecureSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSecureSummary';
    ...
    const STATUS_SETUP_ERROR = 'setup_error';
    const STATUS_ERROR = 'error';
    const STATUS_DECLINED = 'declined';
    const STATUS_CANCELLED = 'cancelled';
    const STATUS_COMPLETE = 'complete';
    const METHOD_CHALLENGE = 'challenge';
    const METHOD_FRICTIONLESS = 'frictionless';
     ...
     * Sets version
     *
     * @param string|null $version The version of 3DS used for this transaction.
     *
     * @return self
     */
    public function setVersion($version)
    {
        ...
        if (!is_null($version) && (!preg_match("/^[1-2].?[\\d+.?]{0,3}$/", $version))) {
            throw new \InvalidArgumentException("invalid value for $version when calling ThreeDSecureSummary., must conform to the pattern /^[1-2].?[\\d+.?]{0,3}$/.");
        }
     ...
     * Sets status
     *
     * @param string|null $status The status of the 3DS challenge for this transaction.
     *
     * @return self
     */
