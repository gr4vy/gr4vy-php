...
class ThreeDSecureV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transaction_reason'] = $data['transaction_reason'] ?? null;
    }
    ...
    public function setEci($eci)
    {
        if (!is_null($eci) && (mb_strlen($eci) > 2)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling ThreeDSecureV2., must be smaller than or equal to 2.');
        }
        if (!is_null($eci) && (mb_strlen($eci) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling ThreeDSecureV2., must be bigger than or equal to 1.');
        }
        if (!is_null($eci) && (!preg_match("/^0?\\d$/", $eci))) {
            throw new \InvalidArgumentException("invalid value for $eci when calling ThreeDSecureV2., must conform to the pattern /^0?\\d$/.");
        }
    ...
    public function setVersion($version)
    {
        ...
        if (!is_null($version) && (!preg_match("/^[1-2].?[\\d+.?]{0,3}$/", $version))) {
            throw new \InvalidArgumentException("invalid value for $version when calling ThreeDSecureV2., must conform to the pattern /^[1-2].?[\\d+.?]{0,3}$/.");
        }
    ...
    public function setAuthenticationResponse($authentication_response)
    {
        ...
        if (!is_null($authentication_response) && (mb_strlen($authentication_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $authentication_response when calling ThreeDSecureV2., must be smaller than or equal to 1.');
        }
    ...
    public function setDirectoryResponse($directory_response)
    {
        ...
        if (!is_null($directory_response) && (mb_strlen($directory_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $directory_response when calling ThreeDSecureV2., must be smaller than or equal to 1.');
        }
     ...
     *
     * @param string|null $transaction_reason The reason identifier for a declined transaction.
     *
     * @return self
     */
