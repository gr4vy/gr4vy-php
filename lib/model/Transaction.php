...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets amount
     *
     * @param float|null $amount The authorized amount for this transaction. This can be different than the actual captured amount and part of this amount may be refunded.
     *
     * @return self
     */
     ...
     *
     * @param float|null $captured_amount The captured amount for this transaction. This can be a part and in some cases even more than the authorized amount.
     *
     * @return self
     */
     ...
     *
     * @param float|null $refunded_amount The refunded amount for this transaction. This can be a part or all of the captured amount.
     *
     * @return self
     */
     ...
     * Sets payment_method
     *
     * @param PaymentMethodSnapshot|null $payment_method The payment method used for this transaction.
     *
     * @return self
     */
     ...
     * Sets buyer
     *
     * @param BuyerSnapshot|null $buyer The buyer used for this transaction.
     *
     * @return self
     */
