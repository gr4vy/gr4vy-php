...
class TransactionCaptureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets amount
     *
     * @param float|null $amount The (partial) amount to capture.  When omitted blank, this will capture the entire amount.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0.0000010)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling TransactionCaptureRequest., must be bigger than or equal to 0.0000010.');
        }
