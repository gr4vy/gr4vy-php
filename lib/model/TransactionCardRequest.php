...
/**
 * TransactionCardRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionCardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionCardRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['expiration_date']) > 5)) {
    ...
    public function setNumber($number)
    {
        if ((mb_strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TransactionCardRequest., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($number) < 13)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TransactionCardRequest., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/^[0-9]{13,19}$/", $number))) {
            throw new \InvalidArgumentException("invalid value for $number when calling TransactionCardRequest., must conform to the pattern /^[0-9]{13,19}$/.");
        }
     ...
     *
     * @param string $expiration_date The expiration date of the card, formatted `MM/YY`.
     *
     * @return self
     */
    public function setExpirationDate($expiration_date)
    {
        if ((mb_strlen($expiration_date) > 5)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling TransactionCardRequest., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($expiration_date) < 5)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date when calling TransactionCardRequest., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/^\\d{2}\/\\d{2}$/", $expiration_date))) {
            throw new \InvalidArgumentException("invalid value for $expiration_date when calling TransactionCardRequest., must conform to the pattern /^\\d{2}\/\\d{2}$/.");
        }
    ...
    public function setSecurityCode($security_code)
    {
        if ((mb_strlen($security_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $security_code when calling TransactionCardRequest., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($security_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $security_code when calling TransactionCardRequest., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^\\d{3,4}$/", $security_code))) {
            throw new \InvalidArgumentException("invalid value for $security_code when calling TransactionCardRequest., must conform to the pattern /^\\d{3,4}$/.");
        }
