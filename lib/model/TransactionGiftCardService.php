...
/**
 * TransactionGiftCardService Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionGiftCardService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Transaction_gift_card_service';
    ...
    public function setGiftCardServiceDefinitionId($gift_card_service_definition_id)
    {
        if (!is_null($gift_card_service_definition_id) && (mb_strlen($gift_card_service_definition_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $gift_card_service_definition_id when calling TransactionGiftCardService., must be smaller than or equal to 50.');
        }
        if (!is_null($gift_card_service_definition_id) && (mb_strlen($gift_card_service_definition_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gift_card_service_definition_id when calling TransactionGiftCardService., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling TransactionGiftCardService., must be smaller than or equal to 200.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling TransactionGiftCardService., must be bigger than or equal to 1.');
        }
