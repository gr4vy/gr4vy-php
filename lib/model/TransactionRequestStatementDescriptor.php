...
/**
 * TransactionRequestStatementDescriptor Class Doc Comment
 *
 * @category Class
 * @package  Gr4vy
 * @author   OpenAPI Generator team
 ...
 */
class TransactionRequestStatementDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionRequest_statement_descriptor';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 22)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TransactionRequestStatementDescriptor., must be smaller than or equal to 22.');
        }
        if (!is_null($name) && (mb_strlen($name) < 5)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TransactionRequestStatementDescriptor., must be bigger than or equal to 5.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 22)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TransactionRequestStatementDescriptor., must be smaller than or equal to 22.');
        }
        if (!is_null($description) && (mb_strlen($description) < 5)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TransactionRequestStatementDescriptor., must be bigger than or equal to 5.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 13)) {
            throw new \InvalidArgumentException('invalid length for $city when calling TransactionRequestStatementDescriptor., must be smaller than or equal to 13.');
        }
        if (!is_null($city) && (mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling TransactionRequestStatementDescriptor., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling TransactionRequestStatementDescriptor., must be smaller than or equal to 20.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling TransactionRequestStatementDescriptor., must be bigger than or equal to 5.');
        }
        if (!is_null($phone_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", $phone_number))) {
            throw new \InvalidArgumentException("invalid value for $phone_number when calling TransactionRequestStatementDescriptor., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (mb_strlen($url) > 13)) {
            throw new \InvalidArgumentException('invalid length for $url when calling TransactionRequestStatementDescriptor., must be smaller than or equal to 13.');
        }
        if (!is_null($url) && (mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling TransactionRequestStatementDescriptor., must be bigger than or equal to 1.');
        }
