...
/**
 * TransactionShippingDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionShippingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Transaction_shipping_details';
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TransactionShippingDetails., must be smaller than or equal to 255.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TransactionShippingDetails., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TransactionShippingDetails., must be smaller than or equal to 255.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TransactionShippingDetails., must be bigger than or equal to 1.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        if (!is_null($email_address) && (mb_strlen($email_address) > 320)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling TransactionShippingDetails., must be smaller than or equal to 320.');
        }
        if (!is_null($email_address) && (mb_strlen($email_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling TransactionShippingDetails., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling TransactionShippingDetails., must be smaller than or equal to 50.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling TransactionShippingDetails., must be bigger than or equal to 1.');
        }
        if (!is_null($phone_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", $phone_number))) {
            throw new \InvalidArgumentException("invalid value for $phone_number when calling TransactionShippingDetails., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
