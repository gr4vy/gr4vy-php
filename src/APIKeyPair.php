...
class APIKeyPair
{
     ...
     *
     * @var ?array<\Gr4vy\ApiCommonSchemasMerchantAccount> $merchantAccounts
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('merchant_accounts')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Gr4vy\ApiCommonSchemasMerchantAccount>|null')]
     ...
     * @param  ?string  $type
     * @param  ?array<\Gr4vy\ApiCommonSchemasMerchantAccount>  $merchantAccounts
