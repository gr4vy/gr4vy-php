...
class Actions
{
    ...
    public function list(string $transactionId, ?string $merchantAccountId = null, ?Options $options = null): ListTransactionActionsResponse
    {
        ...
        $request = new ListTransactionActionsRequest(
            transactionId: $transactionId,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/transactions/{transaction_id}/actions', ListTransactionActionsRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_transaction_actions', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\TransactionActions', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListTransactionActionsResponse(
