...
class Activations
{
     ...
     * @return \Gr4vy\ActivateGiftCardResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function create(GiftCardActivationCreate $giftCardActivationCreate, ?string $idempotencyKey = null, ?string $merchantAccountId = null, ?Options $options = null): ActivateGiftCardResponse
    {
        $request = new ActivateGiftCardRequest(
            giftCardActivationCreate: $giftCardActivationCreate,
            idempotencyKey: $idempotencyKey,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/gift-cards/activations');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'giftCardActivationCreate', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'activate_gift_card', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new ActivateGiftCardResponse(
