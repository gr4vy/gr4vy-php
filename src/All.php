...
class All
{
    ...
    public function create(string $transactionId, ?TransactionRefundAllCreate $transactionRefundAllCreate = null, ?string $merchantAccountId = null, ?Options $options = null): CreateFullTransactionRefundResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/transactions/{transaction_id}/refunds/all', CreateFullTransactionRefundRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'transactionRefundAllCreate', 'json');
        if ($body !== null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_full_transaction_refund', null, $this->sdkConfiguration->securitySource);
