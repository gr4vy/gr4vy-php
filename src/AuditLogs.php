...
class AuditLogs
{
    ...
    private function listIndividual(?ListAuditLogsRequest $request = null, ?Options $options = null): ListAuditLogsResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/audit-logs');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(ListAuditLogsRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_audit_logs', null, $this->sdkConfiguration->securitySource);
