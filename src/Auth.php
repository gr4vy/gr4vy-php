...
class JWTScope
{
    ...
    const BUYERS_BILLING_DETAILS_READ = 'buyers.billingDetails.read';
    const BUYERS_BILLING_DETAILS_WRITE = 'buyers.billingDetails.write';
    ...
    const MERCHANT_ACCOUNT_READ = 'merchant-accounts.reads';
    const MERCHANT_ACCOUNT_WRITE = 'merchant-accounts.write';
    const PAYMENT_METHOD_DEFINITIONS_READ = 'payment-method-definitions.read';
    const PAYMENT_METHOD_READ = 'payment-methods.read';
    const PAYMENT_METHOD_WRITE = 'payment-methods.write';
