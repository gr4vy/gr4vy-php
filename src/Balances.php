...
class Balances
{
     ...
     */
    public function list(GiftCardBalanceRequest $giftCardBalanceRequest, ?float $timeoutInSeconds = null, ?string $merchantAccountId = null, ?Options $options = null): ListGiftCardBalancesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/gift-cards/balances');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'giftCardBalanceRequest', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($baseUrl, 'list_gift_card_balances', [], $this->sdkConfiguration->securitySource);
