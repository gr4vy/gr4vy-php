...
class BuyersGiftCards
{
     ...
     */
    public function list(?string $buyerExternalIdentifier = null, ?string $buyerId = null, ?float $timeoutInSeconds = null, ?string $merchantAccountId = null, ?Options $options = null): ListBuyerGiftCardsResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $qp = Utils\Utils::getQueryParams(ListBuyerGiftCardsRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        ...
        $hookContext = new HookContext($baseUrl, 'list_buyer_gift_cards', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new ListBuyerGiftCardsResponse(
