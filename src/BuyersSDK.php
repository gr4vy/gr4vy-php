...
class BuyersSDK
{
    ...
    public function create(BuyerCreate $buyerCreate, ?string $merchantAccountId = null, ?Options $options = null): AddBuyerResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'add_buyer', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $buyerId, ?string $merchantAccountId = null, ?Options $options = null): DeleteBuyerResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete_buyer', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $buyerId, ?string $merchantAccountId = null, ?Options $options = null): GetBuyerResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_buyer', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    private function listIndividual(?ListBuyersRequest $request = null, ?Options $options = null): ListBuyersResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_buyers', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\Buyers', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
    ...
    public function update(BuyerUpdate $buyerUpdate, string $buyerId, ?string $merchantAccountId = null, ?Options $options = null): UpdateBuyerResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update_buyer', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
