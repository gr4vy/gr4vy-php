...
class Captures
{
     ...
     * @return \Gr4vy\GetTransactionCaptureResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function get(string $transactionId, string $captureId, ?string $merchantAccountId = null, ?Options $options = null): GetTransactionCaptureResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $request = new GetTransactionCaptureRequest(
            transactionId: $transactionId,
            captureId: $captureId,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/transactions/{transaction_id}/captures/{capture_id}', GetTransactionCaptureRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_transaction_capture', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\Capture', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new GetTransactionCaptureResponse(
     ...
     * @param  string  $transactionId
     * @param  ?string  $merchantAccountId
     * @return \Gr4vy\ListTransactionCapturesResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function list(string $transactionId, ?string $merchantAccountId = null, ?Options $options = null): ListTransactionCapturesResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $request = new ListTransactionCapturesRequest(
            transactionId: $transactionId,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/transactions/{transaction_id}/captures', ListTransactionCapturesRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions = array_merge_recursive($httpOptions, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $httpOptions)) {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_transaction_captures', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\CaptureCollection', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListTransactionCapturesResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
