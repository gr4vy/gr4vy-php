...
class CardPaymentMethodCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $expirationDate, string $number, ?string $buyerExternalIdentifier = null, ?string $buyerId = null, ?string $externalIdentifier = null, ?string $cardType = null, ?string $securityCode = null, ?string $method = 'card')
    {
