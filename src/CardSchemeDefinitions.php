...
class CardSchemeDefinitions
{
    ...
    public function list(?string $merchantAccountId = null, ?Options $options = null): ListCardSchemeDefinitionsResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'list_card_scheme_definitions', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\CollectionNoCursorCardSchemeDefinition', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListCardSchemeDefinitionsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    collectionNoCursorCardSchemeDefinition: $obj);
