...
class CardSchemeDefinitionsSDK
{
    ...
    public function list(?string $merchantAccountId = null, ?Options $options = null): ListCardSchemeDefinitionsResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_card_scheme_definitions', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\CardSchemeDefinitions', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListCardSchemeDefinitionsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    cardSchemeDefinitions: $obj);
