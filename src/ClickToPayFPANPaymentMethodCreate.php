...
class ClickToPayFPANPaymentMethodCreate
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $expirationDate, string $number, ?string $buyerExternalIdentifier = null, ?string $buyerId = null, ?string $externalIdentifier = null, ?string $cardType = null, ?string $redirectUrl = null, mixed $securityCode = null, string $method = 'click-to-pay')
    {
