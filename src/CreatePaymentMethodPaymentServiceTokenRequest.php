...
class CreatePaymentMethodPaymentServiceTokenRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $paymentMethodId, PaymentServiceTokenCreate $paymentServiceTokenCreate, ?string $merchantAccountId = null, ?string $applicationName = 'core-api')
    {
