...
class DeletePaymentMethodPaymentServiceTokenRequest
{
     ...
     *
     * @var string $paymentServiceTokenId
     */
     ...
     * @phpstan-pure
     */
    public function __construct(string $paymentMethodId, string $paymentServiceTokenId, ?string $merchantAccountId = null, ?string $applicationName = 'core-api')
    {
