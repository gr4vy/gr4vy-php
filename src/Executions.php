...
class Executions
{
    ...
    public function url(string $reportId, string $reportExecutionId, ?string $merchantAccountId = null, ?Options $options = null): CreateReportExecutionUrlResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_report_execution_url', [], $this->sdkConfiguration->securitySource);
    ...
    public function get(string $reportExecutionId, ?string $merchantAccountId = null, ?Options $options = null): GetReportExecutionResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_report_execution', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \Gr4vy\errors\APIException
     */
    private function allIndividual(?ListAllReportExecutionsRequest $request = null, ?Options $options = null): ListAllReportExecutionsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
     ...
     * @throws \Gr4vy\errors\APIException
     */
    public function all(?ListAllReportExecutionsRequest $request = null, ?Options $options = null): \Generator
    {
    ...
    private function listIndividual(string $reportId, ?string $cursor = null, ?int $limit = null, ?string $merchantAccountId = null, ?Options $options = null): ListReportExecutionsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_report_executions', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
