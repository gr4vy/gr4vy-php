...
class GiftCardsSDK
{
    ...
    public function create(GiftCardCreate $giftCardCreate, ?string $merchantAccountId = null, ?Options $options = null): CreateGiftCardResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_gift_card', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $giftCardId, ?string $merchantAccountId = null, ?Options $options = null): DeleteGiftCardResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete_gift_card', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $giftCardId, ?string $merchantAccountId = null, ?Options $options = null): GetGiftCardResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_gift_card', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    private function listIndividual(?ListGiftCardsRequest $request = null, ?Options $options = null): ListGiftCardsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_gift_cards', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
