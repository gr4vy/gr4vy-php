...
class GuestBuyerInput
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $displayName = null, ?string $externalIdentifier = null, ?BillingDetailsInput $billingDetails = null, ?string $accountNumber = null, ?ShippingDetailsCreate $shippingDetails = null)
    {
