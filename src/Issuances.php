...
class Issuances
{
     ...
     * @return \Gr4vy\IssueGiftCardResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function create(GiftCardIssuanceCreate $giftCardIssuanceCreate, ?string $idempotencyKey = null, ?string $merchantAccountId = null, ?Options $options = null): IssueGiftCardResponse
    {
        $request = new IssueGiftCardRequest(
            giftCardIssuanceCreate: $giftCardIssuanceCreate,
            idempotencyKey: $idempotencyKey,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/gift-cards/issuances');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'giftCardIssuanceCreate', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'issue_gift_card', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\GiftCardIssuance', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new IssueGiftCardResponse(
