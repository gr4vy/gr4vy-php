...
class Jobs
{
     ...
     */
    public function create(AccountUpdaterJobCreate $accountUpdaterJobCreate, ?string $applicationName = null, ?string $merchantAccountId = null, ?Options $options = null): CreateAccountUpdaterJobResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/account-updater/jobs');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'accountUpdaterJobCreate', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_account_updater_job', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\AccountUpdaterJob', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new CreateAccountUpdaterJobResponse(
