...
class ListBuyersRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $merchantAccountId = null, ?string $cursor = null, ?string $search = null, ?string $externalIdentifier = null, ?int $limit = 20, ?string $applicationName = 'core-api')
    {
