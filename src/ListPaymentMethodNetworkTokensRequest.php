...
class ListPaymentMethodNetworkTokensRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $paymentMethodId, ?string $merchantAccountId = null, ?string $applicationName = 'core-api')
    {
