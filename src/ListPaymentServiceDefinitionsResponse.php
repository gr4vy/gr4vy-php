...
class ListPaymentServiceDefinitionsResponse
{
    /**
     ...
     * Successful Response
     *
     * @var ?\Gr4vy\PaymentServiceDefinitions $paymentServiceDefinitions
     */
     ...
     * @param  ?\Gr4vy\PaymentServiceDefinitions  $paymentServiceDefinitions
     * @phpstan-pure
     */
     ...
     */
    public function __call($name, $args): ?ListPaymentServiceDefinitionsResponse
    {
        if ($name === 'next') {
