...
class NetworkTokensCryptogram
{
    ...
    public function create(CryptogramCreate $cryptogramCreate, string $paymentMethodId, string $networkTokenId, ?string $merchantAccountId = null, ?Options $options = null): CreatePaymentMethodNetworkTokenCryptogramResponse
    {
        ...
        $body = Utils\Utils::serializeRequestBody($request, 'cryptogramCreate', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_payment_method_network_token_cryptogram', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\Cryptogram', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new CreatePaymentMethodNetworkTokenCryptogramResponse(
