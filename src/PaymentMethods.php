...
class PaymentMethods
{
     ...
     */
    public function create(CardPaymentMethodCreate|RedirectPaymentMethodCreate|CheckoutSessionPaymentMethodCreate $requestBody, ?float $timeoutInSeconds = null, ?string $merchantAccountId = null, ?Options $options = null): CreatePaymentMethodResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'create_payment_method', [], $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $paymentMethodId, ?string $merchantAccountId = null, ?Options $options = null): DeletePaymentMethodResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'delete_payment_method', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $paymentMethodId, ?string $merchantAccountId = null, ?Options $options = null): GetPaymentMethodResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'get_payment_method', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    private function listIndividual(?ListPaymentMethodsRequest $request = null, ?Options $options = null): ListPaymentMethodsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($baseUrl, 'list_payment_methods', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
