...
class PaymentMethodsPaymentServiceTokens
{
    ...
    public function create(PaymentServiceTokenCreate $paymentServiceTokenCreate, string $paymentMethodId, ?string $merchantAccountId = null, ?Options $options = null): CreatePaymentMethodPaymentServiceTokenResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_payment_method_payment_service_token', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $paymentMethodId, string $paymentServiceTokenId, ?string $merchantAccountId = null, ?Options $options = null): DeletePaymentMethodPaymentServiceTokenResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete_payment_method_payment_service_token', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function list(string $paymentMethodId, ?string $paymentServiceId = null, ?string $merchantAccountId = null, ?Options $options = null): ListPaymentMethodPaymentServiceTokensResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_payment_method_payment_service_tokens', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PaymentServiceTokens', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListPaymentMethodPaymentServiceTokensResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    paymentServiceTokens: $obj);
