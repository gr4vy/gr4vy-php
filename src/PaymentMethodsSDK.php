...
class PaymentMethodsSDK
{
    private SDKConfiguration $sdkConfiguration;
    public PaymentMethodsPaymentServiceTokens $paymentServiceTokens;

    public PaymentMethodsNetworkTokens $networkTokens;
    ...
    public function __construct(public SDKConfiguration $sdkConfig)
    {
        ...
        $this->paymentServiceTokens = new PaymentMethodsPaymentServiceTokens($this->sdkConfiguration);
        $this->networkTokens = new PaymentMethodsNetworkTokens($this->sdkConfiguration);
    }
    /**
    ...
    public function create(CardPaymentMethodCreate|RedirectPaymentMethodCreate|CheckoutSessionPaymentMethodCreate|PlaidPaymentMethodCreate|ACHBankPaymentMethodCreate|BACSBankPaymentMethodCreate|SEPABankPaymentMethodCreate $requestBody, ?string $merchantAccountId = null, ?Options $options = null): CreatePaymentMethodResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_payment_method', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $paymentMethodId, ?string $merchantAccountId = null, ?Options $options = null): DeletePaymentMethodResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete_payment_method', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $paymentMethodId, ?string $merchantAccountId = null, ?Options $options = null): GetPaymentMethodResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_payment_method', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    private function listIndividual(?ListPaymentMethodsRequest $request = null, ?Options $options = null): ListPaymentMethodsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_payment_methods', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PaymentMethods', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  string  $paymentMethodId
     * @param  ?string  $merchantAccountId
     * @return \Gr4vy\UpdatePaymentMethodResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function update(PaymentMethodUpdate $paymentMethodUpdate, string $paymentMethodId, ?string $merchantAccountId = null, ?Options $options = null): UpdatePaymentMethodResponse
    {
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/payment-methods/{payment_method_id}', UpdatePaymentMethodRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'paymentMethodUpdate', 'json');
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $httpOptions = array_merge_recursive($httpOptions, $body);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update_payment_method', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PaymentMethod', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new UpdatePaymentMethodResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    paymentMethod: $obj);
