...
class PaymentOptions
{
    ...
    public function list(PaymentOptionRequest $paymentOptionRequest, ?string $merchantAccountId = null, ?Options $options = null): ListPaymentOptionsResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/payment-options');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'paymentOptionRequest', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($baseUrl, 'list_payment_options', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\CollectionNoCursorPaymentOption', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListPaymentOptionsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    collectionNoCursorPaymentOption: $obj);
