...
class PaymentServiceTokens
{
     ...
     */
    public function create(PaymentServiceTokenCreate $paymentServiceTokenCreate, string $paymentMethodId, ?float $timeoutInSeconds = null, ?string $merchantAccountId = null, ?Options $options = null): CreatePaymentMethodPaymentServiceTokenResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/payment-methods/{payment_method_id}/payment-service-tokens', CreatePaymentMethodPaymentServiceTokenRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'paymentServiceTokenCreate', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($baseUrl, 'create_payment_method_payment_service_token', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PaymentServiceToken', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new CreatePaymentMethodPaymentServiceTokenResponse(
     ...
     * @throws \Gr4vy\errors\APIException
     */
    public function delete(string $paymentMethodId, string $paymentServiceTokenId, ?float $timeoutInSeconds = null, ?string $merchantAccountId = null, ?Options $options = null): DeletePaymentMethodPaymentServiceTokenResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'delete_payment_method_payment_service_token', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
    ...
    public function list(string $paymentMethodId, ?string $paymentServiceId = null, ?string $merchantAccountId = null, ?Options $options = null): ListPaymentMethodPaymentServiceTokensResponse
    {
        ...
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        $url = Utils\Utils::generateUrl($baseUrl, '/payment-methods/{payment_method_id}/payment-service-tokens', ListPaymentMethodPaymentServiceTokensRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(ListPaymentMethodPaymentServiceTokensRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions = array_merge_recursive($httpOptions, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $httpOptions)) {
            $httpOptions['headers'] = [];
        }
        ...
        $hookContext = new HookContext($baseUrl, 'list_payment_method_payment_service_tokens', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\CollectionNoCursorPaymentServiceToken', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListPaymentMethodPaymentServiceTokensResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    collectionNoCursorPaymentServiceToken: $obj);
