...
class PlaidPaymentMethodCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $token, ?string $accountId = null, ?string $paymentServiceId = null, ?string $buyerId = null, ?string $buyerExternalIdentifier = null, ?string $method = 'plaid')
    {
        $this->token = $token;
