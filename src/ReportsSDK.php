...
class ReportsSDK
{
    ...
    public function create(ReportCreate $reportCreate, ?string $merchantAccountId = null, ?Options $options = null): AddReportResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'add_report', null, $this->sdkConfiguration->securitySource);
    ...
    public function get(string $reportId, ?string $merchantAccountId = null, ?Options $options = null): GetReportResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_report', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    private function listIndividual(?ListReportsRequest $request = null, ?Options $options = null): ListReportsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_reports', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function put(ReportUpdate $reportUpdate, string $reportId, ?string $merchantAccountId = null, ?Options $options = null): UpdateReportResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update_report', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
