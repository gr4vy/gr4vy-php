...
class Roles
{
     ...
     * @param  ?string  $cursor
     * @param  ?int  $limit
     * @return \Gr4vy\ListRolesResponse
     * @throws \Gr4vy\errors\APIException
     */
    private function listIndividual(?string $cursor = null, ?int $limit = null, ?Options $options = null): ListRolesResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $qp = Utils\Utils::getQueryParams(ListRolesRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_roles', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\CollectionRole', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                ...
                $response->next = function () use ($sdk, $responseData, $request): ?ListRolesResponse {
     ...
     * @param  ?string  $cursor
     * @param  ?int  $limit
     * @return \Generator<\Gr4vy\ListRolesResponse>
     * @throws \Gr4vy\errors\APIException
     */
