...
class Sessions
{
     ...
     * @return \Gr4vy\CompletePazeMobileSessionResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function pazeMobileSessionComplete(PazeSessionCompleteRequest $pazeSessionCompleteRequest, ?string $merchantAccountId = null, ?Options $options = null): CompletePazeMobileSessionResponse
    {
        $request = new CompletePazeMobileSessionRequest(
            pazeSessionCompleteRequest: $pazeSessionCompleteRequest,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/digital-wallets/paze/session/complete');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'pazeSessionCompleteRequest', 'json');
        if ($body === null) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'complete_paze_mobile_session', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PazeSessionComplete', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new CompletePazeMobileSessionResponse(
     ...
     * @param  ?string  $merchantAccountId
     * @return \Gr4vy\CreatePazeDigitalWalletSessionResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function paze(PazeSessionRequest $pazeSessionRequest, ?string $merchantAccountId = null, ?Options $options = null): CreatePazeDigitalWalletSessionResponse
    {
        $request = new CreatePazeDigitalWalletSessionRequest(
            pazeSessionRequest: $pazeSessionRequest,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/digital-wallets/paze/session');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'pazeSessionRequest', 'json');
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $httpOptions = array_merge_recursive($httpOptions, $body);
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_paze_digital_wallet_session', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PazeWebSession|\Gr4vy\PazeMobileSession', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new CreatePazeDigitalWalletSessionResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
     ...
     * @param  ?string  $merchantAccountId
     * @return \Gr4vy\CreatePazeMobileSessionResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function pazeMobileSessionCreate(PazeMobileSessionCreateRequest $pazeMobileSessionCreateRequest, ?string $merchantAccountId = null, ?Options $options = null): CreatePazeMobileSessionResponse
    {
        $request = new CreatePazeMobileSessionRequest(
            pazeMobileSessionCreateRequest: $pazeMobileSessionCreateRequest,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/digital-wallets/paze/session/create');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'pazeMobileSessionCreateRequest', 'json');
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $httpOptions = array_merge_recursive($httpOptions, $body);
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create_paze_mobile_session', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PazeMobileSessionCreate', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new CreatePazeMobileSessionResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
     ...
     * @param  ?string  $merchantAccountId
     * @return \Gr4vy\ReviewPazeMobileSessionResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function pazeMobileSessionReview(PazeSessionReviewRequest $pazeSessionReviewRequest, ?string $merchantAccountId = null, ?Options $options = null): ReviewPazeMobileSessionResponse
    {
        $request = new ReviewPazeMobileSessionRequest(
            pazeSessionReviewRequest: $pazeSessionReviewRequest,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/digital-wallets/paze/session/review');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'pazeSessionReviewRequest', 'json');
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $httpOptions = array_merge_recursive($httpOptions, $body);
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'review_paze_mobile_session', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\PazeSessionReview', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ReviewPazeMobileSessionResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
