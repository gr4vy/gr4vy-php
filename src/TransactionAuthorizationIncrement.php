...
class TransactionAuthorizationIncrement
{
    /**
     *
     * @var string $status
     ...
     * @phpstan-pure
     */
    public function __construct(string $status, Transaction $transaction, ?string $code = null, ?string $rawResponseCode = null, ?string $rawResponseDescription = null, ?string $type = 'transaction-authorization-increment')
    {
        $this->status = $status;
