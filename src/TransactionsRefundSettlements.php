...
class TransactionsRefundSettlements
{
     ...
     * @return \Gr4vy\GetTransactionRefundSettlementResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function get(string $transactionId, string $settlementId, ?string $merchantAccountId = null, ?Options $options = null): GetTransactionRefundSettlementResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $request = new GetTransactionRefundSettlementRequest(
            transactionId: $transactionId,
            settlementId: $settlementId,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/transactions/{transaction_id}/refund-settlements/{settlement_id}', GetTransactionRefundSettlementRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_transaction_refund_settlement', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Gr4vy\RefundSettlement', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new GetTransactionRefundSettlementResponse(
     ...
     * @param  string  $transactionId
     * @param  ?string  $merchantAccountId
     * @return \Gr4vy\ListTransactionRefundSettlementsResponse
     * @throws \Gr4vy\errors\APIException
     */
    public function list(string $transactionId, ?string $merchantAccountId = null, ?Options $options = null): ListTransactionRefundSettlementsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $request = new ListTransactionRefundSettlementsRequest(
            transactionId: $transactionId,
            merchantAccountId: $merchantAccountId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/transactions/{transaction_id}/refund-settlements', ListTransactionRefundSettlementsRequest::class, $request, $this->sdkConfiguration->globals);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions = array_merge_recursive($httpOptions, Utils\Utils::getHeaders($request, $this->sdkConfiguration->globals));
        if (! array_key_exists('headers', $httpOptions)) {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_transaction_refund_settlements', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Gr4vy\RefundSettlements', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new ListTransactionRefundSettlementsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    refundSettlements: $obj);
