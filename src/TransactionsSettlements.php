...
class TransactionsSettlements
{
    ...
    public function get(string $transactionId, string $settlementId, ?string $merchantAccountId = null, ?Options $options = null): GetTransactionSettlementResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get_transaction_settlement', null, $this->sdkConfiguration->securitySource);
    ...
    public function list(string $transactionId, ?string $merchantAccountId = null, ?Options $options = null): ListTransactionSettlementsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list_transaction_settlements', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
