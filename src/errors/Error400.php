...
class Error400
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $message = null, ?array $details = null, ?string $code = 'bad_request', ?int $status = 400, ?string $type = 'error')
    {
        $this->type = $type;
        $this->code = $code;
        $this->status = $status;
    ...
    public function toException(): Error400Throwable
    {
        ...
        return new Error400Throwable($message, (int) $code, $this);
    }
}